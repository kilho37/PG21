...
// 내 거래처 찾기
$$(document).on('click', '[data-page="myorder"] a[id="custfavorite"]', function() {
    // ???
});
...
// 배송신청
$$(document).on('click', '[data-page="myorder"] a#custnew', function() {
    var params = {
...
$$(document).on('ptr:refresh', '[data-page="mylist"] .pull-to-refresh-content', function() {
...
// 기존고객 [가입]
$$(document).on('click', '[data-page="ifind"] a#custrenew', function() {
    ...
    getJSON('myInfoRenew', { in_num, in_id, in_pw, 
        ...
        // panel-left
        $$('.panel.panel-left').find('a[name="login"]').parent().hide();
        $$('.panel.panel-left').find('a[name="logout"]').parent().show();
        // back
...
// 로그인
$$(document).on('click', '[data-page="login"] a#custlog', function() {
    var custid = $$('[data-page="login"] input[name="custid"]');
    var custpw = $$('[data-page="login"] input[name="custpw"]');
    //var custpw_confirm = $$('[data-page="login"] input[name="custpw_confirm"]');
    var custauto = $$('[data-page="login"] input[name="custauto"]');   
...
$$(document).on('click', '[data-page="login"] a#custfind, [data-page="login"] a#custnew, [data-page="login"] a#custold', function() {
    switch(this.id) {
...
$$(document).on('click', '.panel.panel-left a[name="logout"]', function() {
    ...
    // panel-left
    $$('.panel.panel-left').find('a[name="login"]').parent().show();
    $$('.panel.panel-left').find('a[name="logout"]').parent().hide();
    // back
...
// my favorite saerch : 내 거래처 찾기 -> Simple Standalone Autocomplete, f_name
function getFavoriteAutoComplete(params) {
    var ac = myApp.autocomplete({
        openIn: 'popup',
        pageTitle: params.pageTitle + ' - 내 거래처 찾기',
